...
On Error GoTo errHandler 'add simple error handling to catch any runtime error
    ...
    End If
        ...
        contentsOf = Inet1.OpenURL("http://www.YOUSITE.com/update/exampleDisabled.txt")
    If InStr(contentsOf, "disabled") Then 'is disabled written in the txt doc?
        reason = Inet1.OpenURL("http://www.YOUSITE.com/update/reasonDisabled.txt") 'so if it is disabled, give a reason why - you could add this to
    ...
    End If
        ...
        updateString = Inet1.OpenURL("http://www.YOUSITE.com/update/newVersion.txt")
    ...
    If newVer > curVer Then
        ...
        updateText = Inet1.OpenURL("http://www.YOUSITE.com/update/updateText.txt")
        ...
        Inet1.Execute Trim("http://www.YOUSITE.com/update/" & FileName), "GET"
